...
public class EP1QueueTest {
	...
	public void testCua() {
		...
		this.ep1q.fillQueue();
		assertEquals(new Integer(this.ep1q.getQueue().nombreElems()), new Integer(this.ep1q.CAPACITY));
		
		assertEquals(this.ep1q.clearFullQueue(), new String("0 1 2 3 4 5 6 7 8 "));
		
		assertEquals(new Integer(this.ep1q.getQueue().nombreElems()), new Integer(0));
	}
