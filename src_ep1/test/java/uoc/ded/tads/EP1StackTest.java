...
public class EP1StackTest {
	...
	public void testPila() {
		...
		this.ep1q.fillStack();
		assertEquals(new Integer(this.ep1q.getStack().nombreElems()), new Integer(this.ep1q.CAPACITY));
		
		assertEquals(this.ep1q.clearAllStack(), new String("8 7 6 5 4 3 2 1 0 "));
		
		assertEquals(new Integer(this.ep1q.getStack().nombreElems()), new Integer(0));
	}
}
